...
interface MemoryInputProps {
  onRunComparison: (blocks: number[], processes: number[], algorithms: string[]) => void;
}

export const MemoryInput = ({ onRunComparison }: MemoryInputProps) => {
  ...
  return (
    <Card className="p-6 shadow-card">
      <div className="space-y-6">
        ...
        {/* Algorithm Selection */}
        <div className="space-y-3">
          <Label className="text-base font-semibold">Select Algorithms to Run</Label>
          <div className="flex flex-col gap-3">
            {["First Fit", "Best Fit", "Worst Fit", "Next Fit"].map((algorithm) => (
